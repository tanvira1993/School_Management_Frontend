...
<div>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="">material consumes List</a></li>
        </ol>
    </section>
					        ...
					        <div class="modal-dialog">
					            <div class="modal-content">
					                <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Material Consume</h4>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newMaterialConsume.branches_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newMaterialConsume.materials_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newMaterialConsume.inventory_locations_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control" placeholder="Please enter amount" v-model="newMaterialConsume.quantity">
                                        </div>
					        ...
					        <div class="modal-dialog">
					            <div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title"><b>Edit Consumed History</b></h4>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd" v-for="(materialConsume,i) in materialsConsume" :key="i">

                                                    <td>{{i+1}}</td>
                                                    <td>
                                                        <a data-toggle="modal" data-target="#modal-default" class="btn btn-primary btn-sm alert-warning fa fa-pencil" @click="editModal=true; clickedItem = materialConsume"></a>
                                                        <a data-toggle="modal" data-target="#modal-danger"  class="btn btn-sm btn-danger fa fa-trash" @click="deleteModal= true; clickedItem = materialConsume"></a>
                                                    </td>
                                                    <td>{{materialConsume.mName}}</td>
                                                    <td>{{materialConsume.quantity}}</td>
                                                    <td>{{materialConsume.bName}}</td>
                                                    <td>{{materialConsume.lName}}</td>
...
export default MaterialConsumeTemplate