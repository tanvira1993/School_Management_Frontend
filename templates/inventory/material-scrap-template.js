const MaterialScrapTemplate = `
<div>

<section class="content-header">
        <h1>
            Scrap Materials History
        </h1>
            <ol class="breadcrumb">
                <li><router-link to="/"><i class="fa fa-dashboard"></i> Dashboard<router-link></li>
                <li class="active"><a href="">Scrap materials List</a></li>
            </ol>
    </section>
					        ...
					        <div class="modal-dialog">
					            <div class="modal-content">
					                <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Scrap Materials</h4>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newScraps.branches_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newScraps.materials_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="newScraps.inventory_locations_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control" placeholder="Please enter amount" v-model="newScraps.quantity">
                                        </div>
					        ...
					        <div class="modal-dialog">
					            <div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title"><b>Edit Scraps History</b></h4>
                                    </div>
					        ...
					        <div class="modal-dialog">
					          	<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title"><b>Selected materials scrap history will be deleted.</b></h4>
									</div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd" v-for="(scrap,i) in scraps" :key="i">
                                                    <td>{{i+1}}</td>
                                                    <td>
                                                        <a data-toggle="modal" data-target="#modal-default" class="btn btn-primary btn-sm alert-warning fa fa-pencil" @click="editModal=true; clickedItem = scrap"></a>
                                                        <a data-toggle="modal" data-target="#modal-danger"  class="btn btn-sm btn-danger fa fa-trash" @click="deleteModal= true; clickedItem = scrap"></a>
                                                    </td>
                                                    <td>{{scrap.mName}}</td>
...
export default MaterialScrapTemplate